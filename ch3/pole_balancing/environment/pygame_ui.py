...
class PoleBalancingUI:
    ...
    def render(self, state):
        ...
        for marker_pos in self.track_markers:
            ...
            if 0 <= screen_x <= self.screen_width:
                ...
                if marker_pos % 1000 == 0:
                    ...
                    pos_text = font.render(f"{marker_pos/100:.0f}m", True, (200, 200, 200))
        ...
        pos_info = font.render(f"Position: {state[0]:.2f}", True, (255, 255, 255))
        self.screen.blit(pos_info, (10, 10))

        # Camera indicator
        camera_info = font.render(f"Camera at {self.camera_x/self.scale:.2f}", True, (200, 200, 200))
        ...
        shadow = pygame.Surface(
            (self.cart_width + shadow_size, 20),
            pygame.SRCALPHA
        )
        shadow.fill((0, 0, 0, 50))
        self.screen.blit(
            shadow,
            (cart_x - (self.cart_width + shadow_size)/2, cart_y + 25)
        )
